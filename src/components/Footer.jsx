  ...
  return (
    <div className="flex-col justify-center items-center p-8 md:flex-row">
        ...
        <div className="flex justify-center items-center gap-x-6 my-6">
            <div className="w-8"><img src={d} alt="" /></div>
            <div className="w-8"><img src={t} alt="" /></div>
            <div className="w-8"><img src={i} alt="" /></div>
            <div className="w-8"><img src={l} alt="" /></div>
            <div className="w-8"><img src={o} alt="" /></div>
        </div>

...
function Navbaar(){
    return(
        <div className=" bg-white fixed top-0 w-full py-2 px-2 flex justify-between items-center z-50">
            <div className="flex">
                <div><img className="w-12 h-8 pr-0" src={logo} alt="" /></div>
                <div className="font-[800] text-[20px] font-TT Commons Pro">humankind</div>
            </div>
